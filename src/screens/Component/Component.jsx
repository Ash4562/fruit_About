...
const fruits = [
  {
    ...
    nutrition: [
      ...
      { name: "Calcium", value: "5 mg", position: "-right-11 top-[400px]", variant: "light", size: "md" },
    ],
  },
  {
    name: "WATERMELON",
    ...
    nutrition: [
      ...
      { name: "Protein", value: "0.6 Kg", position: "left-[730px] top-[290px]", size: "xs" },
      { name: "Vitamin C", value: "8.1 mg", position: "left-[100px] top-[300px]", size: "xs" },
      { name: "Energy", value: "30 kcal", position: "-right-12 top-[168px]", variant: "light", size: "md" },
      { name: "Calcium", value: "7 mg", position: "-right-[80px] top-[380px]", variant: "light", size: "md" },
    ],
  },
  {
    name: "STRAWBERRY",
    ...
    nutrition: [
      ...
      { name: "Vitamin C", value: "58.8 mg", position: "left-[100px] top-[330px]", size: "xs" },
      { name: "Energy", value: "32 kcal", position: "-right-12 top-[168px]", variant: "light", size: "md" },
      { name: "Calcium", value: "16 mg", position: "-right-[70px] top-[400px]", variant: "light", size: "md" },
    ],
  },
  {
    name: "KIWI",
    ...
    nutrition: [
      ...
      { name: "Protein", value: "1.1 Kg", position: "left-[800px] top-[290px]", size: "xs" },
      ...
      { name: "Calcium", value: "34 mg", position: "-right-11 top-[390px]", variant: "light", size: "md" },
    ],
  },
  {
    name: "APPLE",
    ...
    nutrition: [
      ...
      { name: "Calcium", value: "6 mg", position: "-right-11 top-[390px]", variant: "light", size: "md" },
    ],
  },
];
...
export const Component = () => {
  ...
  const getBgGradient = () => {
    switch (currentFruit.name) {
      case "BANANA":
        return "bg-gradient-to-b from-[#FFD700] to-[#FFF4B8] mb-";
      case "WATERMELON":
  ...
  return (
    <main className={`relative w-full h-screen overflow-hidden transition-all duration-700 ease-in-out ${getBgGradient()}`} id="home">
      {/* Menu Overlay */}
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
      ...
      <div className="container  relative mx-auto  px-5 py-6 h-full md:max-w-[1440px]  ">
        ...
        <div className="relative w-full max-w-[1022px] md:!-mb-96 mx-auto md:ml-44 mt-80 md:mt-[30px]">
          <div className="relative">
            ...
            {/* Navigation Buttons */}
            <div className="flex justify-center gap-4 mt-3 md:-mt-56">
              <Button size="icon" variant="default" onClick={handlePrev} className="text-black rotate-180 bg-white rounded-full size-8 md:size-11">
                <ChevronRightIcon className="w-6 h-6 " />
              </Button>
              <Button size="icon" variant="default" onClick={handleNext} className="z-10 text-black bg-white rounded-full size-8 md:size-11">
                <ChevronRightIcon className="w-6 h-6" />
              </Button>
            </div>
            ...
            <div className="absolute md:top-[95px] -top-[210px] hidden md:block md:-left-32 font-['Poppins',Helvetica]">
              <h2 className="mt-2 text-xl font-medium md:text-3xl">
              ...
              <p className={`w-[339px] md:mt-4 text-base leading-[31px] ${colors.secondary}`}>
                {getDescription()}
              </p>
            </div>
